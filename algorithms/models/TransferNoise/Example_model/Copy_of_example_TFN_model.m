...
% Open file of all bore head data

% Get list of unique bore IDs

% Loop through each bore ID

    % Filter data for current ID and save in temp data variable

    % Build 6 param model ONE state model , run calibrate model

    % Build 6 param model HMM state model , run calibrate model

    % save both model results to file
